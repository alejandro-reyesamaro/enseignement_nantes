...
\def\Address{\textifsymbol{18} 2 rue de la Houssiniere 44322 Nantes, Fance} % Your address
\def\CityZip{\hbox{} \hspace{4pt} 44322 Nantes, Fance} % Your city, zip code, country, etc
