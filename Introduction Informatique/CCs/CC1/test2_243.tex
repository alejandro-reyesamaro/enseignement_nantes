...
\newcommand{\examnum}{CC 2}
\newcommand{\examdate}{??/??/2017}
...
% Basic question
%\addpoints
\question \'Ecrire un algorithme qui demande de saisir un nombre et afficher sa {\bf factorisation entière en nombres premiers}, qui consiste \`a chercher \`a \'ecrire un entier naturel non nul sous forme d'un produit de nombres premiers. Par exemple, si le nombre donné est 45, sa \textit{factorisation en nombres premiers} est : $3^2 \times 5$, soit $3 \times 3 \times 5$
\end{questions}
\end{document}