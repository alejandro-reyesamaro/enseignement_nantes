...
int main(int argc, char *argv[])
{
	...
	sem_init(&mutex_deer, 0,0);
	sem_init(&mutex_hunter, 0,0);
	sem_init(&mutex_inspector, 0,1);
	...
	sem_destroy(&mutex_deer);
	sem_destroy(&mutex_hunter);
	sem_destroy(&mutex_inspector);
